  ...
  <div class="app">
    ...
    <div class="jsapi-panel">
      ...
      <div class="panel-content">
        ...
        <div class="section">
          <h4>批注操作</h4>
          <button @click="handleGetAllComments" class="btn btn-secondary">获取所有批注</button>
          <div class="input-group">
            <input v-model="commentText" type="text" placeholder="批注内容" class="input" />
            <button @click="handleAddComment" class="btn btn-secondary">添加批注</button>
          </div>
          <div class="input-group" style="margin-top: 8px">
            <input
              ...
              class="input"
            />
            <button @click="handleAddCommentToSelection" class="btn btn-secondary">
              在选中内容添加批注
            </button>
          </div>
        </div>
